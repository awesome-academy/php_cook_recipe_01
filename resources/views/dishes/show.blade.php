                                ...
                                <div class="row">
                                    ...
                                    <div class="product-info col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                        ...
                                        <div class="product-info__description hidden-xs">
                                            <div class="product-info__description__brand"><img src="{{ config('asset.image_path.avatar_owner').'2.jpg' }}" class="avatar_chef" alt=""/></div>
                                            <div class="product-info__description__text">
                                                <a href="#">{{ trans('dish.repice') }}: <strong class="color">{{ trans('dish.owner') }}</strong></a>
                                                <div class="divider divider--xs product-info__divider hidden-xs"></div>
                                                "{{ $dish->description }}"
                                            </div>
                                        </div>
